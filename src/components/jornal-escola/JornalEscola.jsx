...
export function JornalEscola() {
            ...
            <div className="je-container">
                ...
                <div className="je-hero">
                    <h1 className="je-hero__title">
                        <span className="je-hero__title-icon">
    <svg width="28" height="28" viewBox="0 0 24 24" fill="none"
         stroke="#d93025" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M4 22h16a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H8a2 2 0 0 0-2 2v16a2 2 0 0 0-2 2zm0 0a2 2 0 0 1-2-2V9a1 1 0 0 1 1-1h2"/>
    ...
    <span className="je-card__meta-item">
